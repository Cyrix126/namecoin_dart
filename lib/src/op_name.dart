...
class OpNameData {
  ...
  /// Construct a instance of NameCoinOpName by giving the "nameOp" data as Json
  ///
  ...
  /// Takes a transaction data and a String containing a height field to create an instance of NameCoinOpName
  ...
  static OpNameData fromTx(String txData, String txHash) {
    ...
    throw Exception(
        'The class NameCoinOpName can not be constructed from the transaction: $txData');
  }
...
enum OpName {
  ...
  static OpName fromString(String value) {
    final opName = switch (value) {
      'name_new' => OpName.nameNew,
      'name_firstupdate' => OpName.nameFirstUpdate,
      'name_update' => OpName.nameUpdate,
      _ => throw Exception(
